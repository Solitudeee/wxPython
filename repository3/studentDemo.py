...
class MyFrame(wx.Frame):
    ...
    def __init__(self, parent, id):
        ...
        self.menu1 = wx.Menu()
        self.M_new=self.menu1.Append(-1, '新建')
        self.menu1.AppendSeparator()
        self.M_exit=self.menu1.Append(-1, '退出')
        self.menuBar.Append(self.menu1, '开始')
        ...
        self.menuBar.Append(self.menu2, '操作')
    ...
    def grid_left_click(self,event):
        ...
        # 设置状态栏的文字
        txt='点击了'+str(event.GetRow())+'行'+str(event.GetCol())+'列，'+'值是'+str(self.grid.GetCellValue(event.GetRow(),event.GetCol()))
